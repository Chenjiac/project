 ...
 */
@Service("boxService")
public class BoxService implements BoxManager {
	...
	public List<PageData> list(Page page)throws Exception{
		return (List<PageData>)dao.findForList("BoxMapper.datalistPage", page);
	}
	 ...
	 * @throws Exception
	 */
	public PageData findByBoxSN(PageData pd)throws Exception{
		return (PageData)dao.findForObject("BoxMapper.findByBoxSN",pd);
	}
