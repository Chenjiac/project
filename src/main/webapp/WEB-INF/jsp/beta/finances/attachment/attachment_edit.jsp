			...
			<div class="page-content">
				<div class="row">
					<div class="col-xs-12">
						...
						<form action="finance_attachment/${msg }.do" name="Form" id="Form" method="post">
							<input type="hidden" value="no" id="hasTp1" />
							<div id="zhongxin" style="padding-top: 13px;">
								<table id="table_report" class="table table-striped table-bordered table-hover">
									<tr>
										<td style="width:75px;text-align: right;padding-top: 13px;">文件名:</td>
										<td><input type="text" name="ATTACHMENT_NAME" id="ATTACHMENT_NAME" value="" maxlength="30" placeholder="这里输入文件名" title="文件名" style="width:98%;"/></td>
									</tr>
									<tr>
									...
									<td><input type="text" name="ATTACHMENT_DESCRIPTION" id="ATTACHMENT_DESCRIPTION" value="" maxlength="100" placeholder="这里输入备注" title="备注" style="width:98%;"/></td>
									</tr>
									<tr>
										<td style="width:75px;text-align: right;padding-top: 13px;">文档编号:</td>
										<td><input type="text" name="FINANCE_ID" id="FINANCE_ID" value="" maxlength="100" placeholder="这里输入文档编号" title="文档编号" style="width:98%;"/></td>
									</tr>
									<tr>
