					...
					<div class="row">
						...
						<table style="margin-top:5px;">
							<tr>
								...
								<%--<td><span style="color: #00a0c6;font-size:14px;">&nbsp;&nbsp;从excel导入数据</span></td>--%>
							</tr>
						</table>
						<!-- 检索  -->
								...
								<c:when test="${not empty varList}">
									...
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr>
											...
											<%--<td class='center'>${var.UNROLLING_PAPER_ID}</td>--%>
...
//			alert(num);
        ...
        function fromExcel(){
            ...
            diag.URL = '<%=basePath%>paper/goUploadExcel.do';
            diag.Width = 300;
            diag.Height = 150;
            diag.CancelEvent = function(){ //关闭事件
                if(diag.innerFrame.contentWindow.document.getElementById('zhongxin').style.display == 'none'){
