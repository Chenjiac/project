			...
			<div class="page-content">
				<div class="row">
					<div class="col-xs-12">
						...
						<form action="unrolling_attachment/${msg }.do" name="Form" id="Form" method="post">
							...
							<div id="zhongxin" style="padding-top: 13px;">
								<table id="table_report" class="table table-striped table-bordered table-hover">
									...
									<tr>
										...
										<td><input type="text" name="PAPER_ID" id="PAPER_ID" value="" maxlength="100" placeholder="这里输入文档编号" title="文档编号" style="width:98%;"/></td>
									</tr>
									<tr>
